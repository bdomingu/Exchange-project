class Agent extends Client {
    ...
    public void BuyBTC() {
        ...
        System.out.println("Purchases $860 of BTC:" + ' ' + values.updateETHBalance(860, true));
        System.out.println("Purchases $80 of BTC:" + ' ' + values.updateBNBBalance(80, true));
    ...
    public void SellBTC() {
        ...
        System.out.println("Sells .2 bitcoin:" + ' ' + values.updateETHBalance(.2, false));
